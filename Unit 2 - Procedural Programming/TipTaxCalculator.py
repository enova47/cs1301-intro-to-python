...
#Add your code here!
SubTotal = "Subtotal: " + str(meal_cost)
print(SubTotal)
Tax = "Tax: " + str(tax_rate * meal_cost)
print(Tax)
Tip = "Tip: " + str(tip_rate * meal_cost)
print(Tip)
Total = float(meal_cost + (tax_rate * meal_cost) + (tip_rate * meal_cost))
